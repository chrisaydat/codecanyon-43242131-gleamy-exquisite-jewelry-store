...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $order['total_delivered'] = Order::where('status',4)->count();
        ...
        $salesCart['labels'] = $deposits->keys();
        $salesCart['values'] = $deposits->values();
        ...
        return view('admin.dashboard', compact('order','pageTitle', 'widget','salesCart', 'deposit','userLogins', 'newTickets'));
    }
