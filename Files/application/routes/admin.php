...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CategoryController')->group(function () {
        ...
        Route::get('product/categories', 'index')->name('categories');
        Route::post('product/categories/store', 'store')->name('category.store');
        Route::post('product/categories/update', 'update')->name('category.update');
    });
    ...
    // product
      Route::controller('ProductController')->group(function () {
        ...
        Route::post('product/image/remove', 'imageRemove')->name('product.image.delete');
    });
     ...
     Route::name('orders.')->controller('OrderController')->prefix('orders')->group(function(){
        ...
        Route::get('order/detail/{id}','orderDetail')->name('detail');
        Route::post('order/approve/{id}','orderApprove')->name('approve');
        Route::post('order/reject/{id}','orderReject')->name('reject');

        // Customer orders
        Route::get('custom/orders','getCustomOrders')->name('custom');
        Route::get('custom/orders/details/{id}','customOrderDetails')->name('custom.detail');
    ...
    //  cupon
    Route::name('cupons.')->controller('CuponController')->prefix('cupons')->group(function(){
