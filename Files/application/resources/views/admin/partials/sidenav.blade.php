        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.products*')}}">
                    ...
                    {{-- cupon --}}
                    <li class="sidebar-menu-item {{menuActive('admin.cupons*')}}">
                        <a href="{{route('admin.cupons.index')}}" class="nav-link ">
                            <i class=" las la-percent menu-icon"></i>
                            <span class="menu-title">@lang('Cupons')</span>
                        </a>
                    </li>
                    {{-- end cupon --}}
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.orders*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.orders.custom')}} ">
                                <a href="{{route('admin.orders.custom')}}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
                                    <span class="menu-title">@lang('Custom Orders')</span>
                                </a>
                            </li>
...
<li class="sidebar-menu-item sidebar-dropdown">
    ...
    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
        <ul>
            @php
            $cruds = collect(request()->segments())->last();
            @endphp
            @foreach(getPageSections(true) as $k => $secs)
            @if($secs['builder'])
            <li class="sidebar-menu-item  @if($cruds == $k) active @endif ">
