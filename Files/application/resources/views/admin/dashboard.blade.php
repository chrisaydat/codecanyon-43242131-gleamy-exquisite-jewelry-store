...
<div class="row gy-4">
    <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">@lang('Monthly Product Sales  Report') (@lang('This Month'))</h5>
                    ...
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Order')</h6>
                ...
                <a href="{{route('admin.categories')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Category')</h6>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.products')}}"></a>
                                    <h5>{{$order['total_products']}}</h5>
...
<script>
    ...
    (function () {
        var options = {
            ...
            series: [{
                name: '@lang("Sales")',
                data: @json($salesCart['values'])
    }],
    fill: {
        opacity: [0.85, 1],
                },
    labels: @json($salesCart['labels']),
    markers: {
        size: 0
    },
    xaxis: {
